...
function custom_cart_contents() {
  ...
  //if( ! empty ( $lenses_type_settings ) or ! empty ( $these_second_options ) ) {
    $lenses_type_settings = get_user_meta( get_current_user_id(), 'lenses_type_settings', true);
    $lenses_type_settings_field = json_decode( $lenses_type_settings, TRUE );
    //print_r( $lenses_type_settings_field );
    $these_second_options = get_user_meta( get_current_user_id(), 'these_second_options', true );
  ...
  <tbody id="delete-object">
      <tr class="woocommerce-cart-form__cart-item cart_item">
         ...
         <td class="product-name" data-title="Product">
           <a ><?php echo $decode_price['lenses-final-name'] ?></a>
        </td>

         <td class="product-price" data-title="Price">
         <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">£</span><?php echo $decode_price['lense-price'] ?></span>					</td>
...
<!--
         ...
         <a href="" class="remove" title="Remove this item" data-product_id="12" data-cart_item_key="c20ad4d76fe97759aa27a0c99bff6710" data-product_sku="1234567-1-1-1-1-1">×</a>
       </td>
-->
      </tr>
    </tbody>
...
function bbloomer_checkout_radio_choice() {
  ...
  $decode_price = json_decode($price_info, TRUE);
    ...
    'options' => array(
        'no_option' => 'No Option',
        'option_1' => ' ( '.$decode_price[ 'lense-price' ].' )',
