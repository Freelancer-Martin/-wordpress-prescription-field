...
function giftcard_options_product_tab_content() {
    ...
    */
			...
			woocommerce_wp_text_input( array(
				...
				'label'				=> __( 'Single PD Range (MIN)', 'woocommerce' ),
				'desc_tip'			=> 'true',
      ...
      woocommerce_wp_text_input( array(
        ...
        'label'				=> __( 'Single PD Range (MAX)', 'woocommerce' ),
        'desc_tip'			=> 'true',
...
*/
      woocommerce_wp_text_input( array(
        ...
        'label'				=> __( 'Dual PD Range Left (MIN)', 'woocommerce' ),
        'desc_tip'			=> 'true',
        'description'		=> __( 'Dual PD Range Left (MIN)', 'woocommerce' ),
        'type' 				=> 'number',
        'size' => '25',
        'custom_attributes'	=> array(
          'min'	=> '-7',
      ...
      woocommerce_wp_text_input( array(
        ...
        'label'				=> __( 'Dual PD Range Left (MAX)', 'woocommerce' ),
        'desc_tip'			=> 'true',
        'description'		=> __( 'Enter the number of Dual PD Range Left (MAX).', 'woocommerce' ),
        'type' 				=> 'number',
        'size' => '25',
        'custom_attributes'	=> array(
          'min'	=> '-7',
      ...
      woocommerce_wp_text_input( array(
        ...
        'label'				=> __( 'Dual PD Range Right (MIN)', 'woocommerce' ),
        'desc_tip'			=> 'true',
        'description'		=> __( 'Dual PD Range Right (MIN)', 'woocommerce' ),
        'type' 				=> 'number',
        'size' => '25',
        'custom_attributes'	=> array(
          'min'	=> '-7',
      ...
      woocommerce_wp_text_input( array(
        ...
        'label'				=> __( 'Dual PD Range Right (MAX)', 'woocommerce' ),
        'desc_tip'			=> 'true',
        'description'		=> __( 'Enter the number of Dual PD Range Right (MAX).', 'woocommerce' ),
        'type' 				=> 'number',
        'size' => '25',
        'custom_attributes'	=> array(
          'min'	=> '-7',
          ...
          <p class='form-field _redeem_in_stores'>
            ...
            <?php  foreach ($custom_posts as $value) {
              ...
              //  print_r( get_post_meta( $value ) ); ?>
    					  <option <?php selected( in_array( $value , $redeemable_stores ) ); ?> value="<?php print $value ?>">"<?php print $title ?>"</option>
...
function save_giftcard_option_fields( $post_id ) {
  ...
  if ( isset( $_POST['_valid_singe_pd_ranfe_from'] ) ) :
		update_post_meta( $post_id, '_valid_singe_pd_ranfe_from',  $_POST['_valid_singe_pd_ranfe_from'] ) ;
	endif;

  if ( isset( $_POST['_valid_singe_pd_ranfe_to'] ) ) :
		update_post_meta( $post_id, '_valid_singe_pd_ranfe_to', $_POST['_valid_singe_pd_ranfe_to'] ) ;
	endif;

  if ( isset( $_POST['_valid_dual_pd_range_left_from'] ) ) :
		update_post_meta( $post_id, '_valid_dual_pd_range_left_from',  $_POST['_valid_dual_pd_range_left_from'] ) ;
	endif;

  if ( isset( $_POST['_valid_dual_pd_range_left_to'] ) ) :
		update_post_meta( $post_id, '_valid_dual_pd_range_left_to',  $_POST['_valid_dual_pd_range_left_to'] ) ;
	endif;

  if ( isset( $_POST['_valid_dual_pd_range_right_from'] ) ) :
		update_post_meta( $post_id, '_valid_dual_pd_range_right_from',  $_POST['_valid_dual_pd_range_right_from'] ) ;
	endif;

  if ( isset( $_POST['_valid_dual_pd_range_right_to'] ) ) :
		update_post_meta( $post_id, '_valid_dual_pd_range_right_to', $_POST['_valid_dual_pd_range_right_to'] ) ;
	endif;
